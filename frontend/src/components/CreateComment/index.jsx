...
const CreateComment = ({ input, parenReload = () => {} }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${backendUrl}/comments`, formData, {
        headers: {
  ...
  return (
    <div className="create-comment" data-id={data.id} onClick={exit}>
      <div
        className="container"
        onClick={(e) => {
          e.stopPropagation();
      ...
      >
        <div className="head">
          ...
          <div className="text">Tạo bình luận mới</div>
        ...
        <div className="end">
          <div className="box">
            ...
            <div className="text">
              <div
                ref={divRef}
                aria-label="Trường văn bản trống. Hãy nhập vào văn bản để tạo bình luận mới"
